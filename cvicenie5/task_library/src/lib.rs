...
pub trait ReadTaskFromUser {
    pub fn read_id(&self, String: message) -> i32,
    pub fn read_name(&self, String: message) -> String,
    pub fn read_describtion(&self, String: message) -> String,
    pub fn read_priority(&self, String: message) -> i32,
    pub fn read_plan_start (&self, String: message)-> NaiveDate,
    pub fn read_plan_duration(&self, String: message) -> TimeDelta,
    pub fn read_real_start(&self, String: message) -> Option(NaiveDate),
    pub fn read_real_duration(&self, String: message) -> Option(TimeDelta),
}
